    ...
    <View style={[styles.container, { backgroundColor: themeHook.colors.background }]}>
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: themeHook.colors.text }]}>Data & Security</Text>
          <View style={styles.placeholder} />
        </View>
        <View style={[styles.headerDivider, { backgroundColor: themeHook.colors.border }]} />
        <Text style={[styles.lastUpdated, { color: themeHook.colors.textSecondary }]}>Last updated: {new Date().toLocaleDateString()}</Text>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>1. Data Protection and Encryption</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>1.1 Encryption Standards</Text>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>1.2 Security Infrastructure</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>2. Account Security</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>2.1 Password Requirements</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>2.2 Two-Factor Authentication</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>2.3 Account Activity Monitoring</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>3. Payment Security</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.1 PCI DSS Compliance</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.2 Payment Data Handling</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.3 Fraud Prevention</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>4. Data Retention and Deletion</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>4.1 Retention Periods</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>4.2 Data Deletion</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>5. Your Data Rights and Control</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>5.1 Access and Portability</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>5.2 Correction and Updates</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>5.3 Account Settings and Preferences</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>6. Security Incident Response</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>6.1 Incident Detection and Response</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>6.2 Breach Notification</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>6.3 Continuous Improvement</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>7. Third-Party Security</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>7.1 Service Provider Security</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>7.2 Security Audits and Certifications</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>8. Reporting Security Issues</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>8.1 Responsible Disclosure</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>8.2 Security Contact Information</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>9. Compliance and Legal Obligations</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>9.1 Regulatory Compliance</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>9.2 Law Enforcement and Legal Requests</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>10. Changes to This Security Policy</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>11. Contact Us</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
