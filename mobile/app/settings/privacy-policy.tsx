    ...
    <View style={[styles.container, { backgroundColor: themeHook.colors.background, paddingTop: insets.top }]}>
      <ScrollView style={styles.content} contentContainerStyle={[styles.contentContainer, { paddingBottom: Math.max(insets.bottom, theme.spacing['2xl']) }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.title, { color: themeHook.colors.text }]}>Privacy Policy</Text>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>1. Information We Collect</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>1.1 Information You Provide Directly</Text>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>1.2 Automatically Collected Information</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>1.3 Information from Third Parties</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>2. How We Use Your Information</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>3. Information Sharing and Disclosure</Text>
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.1 Service Providers and Business Partners</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.2 Other Users</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.4 Business Transfers</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
          ...
          <Text style={[styles.subsectionTitle, { color: themeHook.colors.text }]}>3.5 With Your Consent</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>4. Data Security</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>5. Your Rights and Choices</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>6. Data Retention</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>7. Cookies and Tracking Technologies</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>8. Children's Privacy</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>9. International Data Transfers</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>10. California Privacy Rights</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>11. Changes to This Privacy Policy</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
        ...
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: themeHook.colors.text }]}>12. Contact Us</Text>
          <Text style={[styles.paragraph, { color: themeHook.colors.textSecondary }]}>
